...
> **Géodésique (définition simple)** : chemin le plus “droit possible” dans une surface ou un espace qui peut être courbé.
...
> **Horizon des événements (définition simple)** : frontière invisible autour du trou noir à partir de laquelle **plus rien ne peut s’échapper**, ni matière ni lumière.

Space.com décrit cette frontière comme un “point de non-retour”. À l’intérieur de cette surface, la courbure de l’espace-temps est tellement forte que la **vitesse de libération** (la vitesse minimale nécessaire pour s’éloigner à l’infini) serait plus grande que la **vitesse de la lumière**, ce qui est interdit par les lois de la physique actuelles.
